...
plot(power$DateTime, power$Global_active_power, typ='l', xlab = "", ylab="Global Active Power (kilowatts)")

plot(power$DateTime, power$Voltage, typ='l', xlab = "datetime", ylab="Voltage")

plot(power$DateTime, power$Sub_metering_1, typ='l', col="black", xlab="", ylab="Energy sub metering")
lines(power$DateTime, power$Sub_metering_2, col="red")
lines(power$DateTime, power$Sub_metering_3, col="blue")
legend('topright', legend=c('Sub_metering_1', 'Sub_metering_2', 'Sub_metering_3'), col=c("black", "red", "blue"), inset=.005, bty = 0, lty=1, box.lty=0)

plot(power$DateTime, power$Global_reactive_power, typ='l', xlab = "datetime", ylab="Global_reactive_power")
